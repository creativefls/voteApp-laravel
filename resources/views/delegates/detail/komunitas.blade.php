    ...
    <div class="col-md-12">
			<div class="card">
				<div class="header">
					...
					<p class="category"><i class="ti ti-calendar"></i> Diperbaharui pada {{ $komunitas->updated_at }}</p>
				</div>
				<hr>
        <div class="content">
										<figure>
          ...
          <div class="text-center">
						<a href="{{ url('/') }}" class="btn btn-warning btn-sm btn-fill"><i class="ti-search"></i> Lainya</a>
